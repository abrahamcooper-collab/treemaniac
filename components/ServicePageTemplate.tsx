		...
		<>
			...
			>
				...
				<div className="max-w-4xl mx-auto relative z-10">
					...
					<h1 className="font-tenor-sans text-white font-bold" style={{ fontSize: "clamp(3rem, 8vw, 5.5rem)", wordBreak: "keep-all", overflowWrap: "normal" }}>
						{title}
					</h1>
			...
			<section className="bg-white py-16 px-6">
				<div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12">
					...
					<div className="flex-1 min-w-0">
						...
						{/* Intro */}
						<h2 className="font-tenor-sans font-bold mb-4" style={{ fontSize: "clamp(2.2rem, 4vw, 3.2rem)", color: "#1B6B2A" }}>
							Tree Maniac&apos;s {title}
						</h2>
